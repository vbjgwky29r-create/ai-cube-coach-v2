      ...
      <div className="px-4 relative z-10">
        <div className="max-w-md sm:max-w-lg mx-auto lg:max-w-none lg:mx-0 lg:grid lg:grid-cols-[1fr_320px] lg:gap-6">
          ...
          <div className="w-full space-y-4">
            {/* 输入区域 + 键盘合体 */}
            <Card className="card-cube shadow-md overflow-hidden">
              {/* 输入框区域 */}
                  ...
                  <div className="flex items-center justify-between mb-1.5">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <button
                        ...
                        className="text-[10px] px-2 py-0.5 rounded transition-colors bg-orange-500 text-white hover:bg-orange-600 flex items-center gap-1 disabled:opacity-50"
            ...
            <Button
              ...
              className={cn(
                "w-full py-5 text-base font-semibold shadow-md",
            ...
            {result && (
              <div className="space-y-4">
                  ...
                  <Card className="card-cube shadow-sm result-card" style={{ animationDelay: '100ms' }}>
                    ...
                    <CardContent className="pt-3 space-y-2">
                      {result.optimizations.map((opt: any, idx: number) => (
                        <div
                          key={idx}
                          className="bg-gradient-to-r from-orange-50 to-blue-50 p-3 rounded-lg border border-orange-200"
                        >
                ...
                {result.learnings && result.learnings.length > 0 && (
                  <Card className="card-cube shadow-md border-2 border-orange-200 result-card" style={{ animationDelay: '400ms' }}>
                    <CardHeader className="border-b border-slate-100">
                      <CardTitle className="flex items-center gap-2">
                        📚 新公式推荐
                      </CardTitle>
                    ...
                    <CardContent className="pt-3 space-y-3">
                      {result.learnings.map((learning: any, idx: number) => (
                        <div
                          key={idx}
                          className="bg-gradient-to-r from-orange-50 to-yellow-50 p-3 rounded-lg border border-orange-200"
                        >
                          <div className="flex items-center justify-between mb-2">
                ...
                {result.prioritizedRecommendations && result.prioritizedRecommendations.length > 0 && (
                  <Card className="card-cube shadow-md border-2 border-orange-200 result-card" style={{ animationDelay: '1200ms' }}>
                    <CardHeader className="border-b border-slate-100">
                      <CardTitle className="flex items-center gap-2">
                        📋 本周改进计划
                      </CardTitle>
                    ...
                    <CardContent className="pt-3 space-y-3">
                      {result.prioritizedRecommendations.slice(0, 3).map((rec: any, idx: number) => (
                        <div key={idx} className="bg-gradient-to-r from-orange-50 to-yellow-50 p-3 rounded-lg border border-orange-200">
          ...
          <div className="hidden lg:block w-[320px] space-y-4 lg:sticky lg:top-6">
            {/* 魔方展开图 */}
            {showCube && cubeState && (
              <Card className="card-cube shadow-md">
            ...
            {/* 最优解卡片 */}
            {optimalResult && (
              <Card className="card-cube shadow-md border-2 border-green-200">
                <CardHeader className="border-b border-slate-100 pb-3">
                  <CardTitle className="flex items-center gap-2 text-sm">
                    <Target className="w-4 h-4 text-green-500" />
                    最优解
